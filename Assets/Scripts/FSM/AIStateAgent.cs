...
public class AIStateAgent : AIAgent
{
    ...
    //parameters
    public ValueRef<float> health = new ValueRef<float>(100f);
    public ValueRef<float> timer = new ValueRef<float>(100f);
    ...
    public ValueRef<float> enemyHealth = new ValueRef<float>(100f);
